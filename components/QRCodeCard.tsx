...
export default function QRCodeCard({ url, eventName }: QRCodeCardProps) {
  ...
  return (
    ...
    >
      <h3 className="text-[11px] font-semibold text-[#8A93BC] uppercase tracking-[0.08em]">QR Kod</h3>
      ...
      <div className="flex justify-center">
        <div className="bg-white p-3 rounded-xl">
          <canvas
            ref={canvasRef}
            role="img"
            aria-label={`QR kod za plaćanje — ${eventName}`}
      ...
      {/* Helper text */}
      <p className="text-xs text-[#8A93BC] leading-relaxed text-center">
